...
/*!
 * \file sparse_flash_attention_for_offload_service_vector_mla.h
 * \brief
 */
#ifndef SPARSE_FLASH_ATTENTION_FOR_OFFLOAD_SERVICE_VECTOR_MLA_H
#define SPARSE_FLASH_ATTENTION_FOR_OFFLOAD_SERVICE_VECTOR_MLA_H
...
public:
    ...
    __aicore__ inline void InitParams(const struct ConstInfo &constInfo,
                                      const SparseFlashAttentionForOffloadTilingDataMla *__restrict tilingData);
...
#endif // SPARSE_FLASH_ATTENTION_FOR_OFFLOAD_SERVICE_VECTOR_MLA_H
