...
/*!
 * \file sparse_flash_attention_for_offload_def.cpp
 * \brief
 */
...
namespace ops {
class SparseFlashAttentionForOffload : public OpDef {
public:
    explicit SparseFlashAttentionForOffload(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
...
OP_ADD(SparseFlashAttentionForOffload);
} // namespace ops
