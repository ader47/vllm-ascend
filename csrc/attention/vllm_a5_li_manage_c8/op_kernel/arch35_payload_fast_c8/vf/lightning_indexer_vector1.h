...
/*!
 * \file lightning_indexer_VllmFastVector1.h
 * \brief
 */
#ifndef VLLM_FAST_LIGHTNING_INDEXER_VECTOR1_H
#define VLLM_FAST_LIGHTNING_INDEXER_VECTOR1_H

#include "kernel_operator.h"

namespace VllmFastVector1 {
